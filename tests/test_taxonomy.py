...
# Tiny synthetic taxdump: root -> Eukaryota -> Actinopterygii -> {Gadus, Urophycis}
NODES = [
    (1, 1, "no rank"),
    (2759, 1, "superkingdom"),
    (7898, 2759, "class"),
...
def test_clean_taxon():
    ...
    assert otax.clean_taxon("Gadus cf. morhua") == "Gadus"
...
def test_ranked_lineage_columns(tmp_path):
    ...
    assert d["lineage"] == "Eukaryota; Actinopterygii; Gadus; Gadus morhua"
